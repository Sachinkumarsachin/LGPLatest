...
selectparentalOptionAccordingToAge(ageRating:number){
    ...
    get contentHeadersAccordingToRatings() {
      ...
      contentRailHeaders(contentHeader:string,index: number) {
        return $(
          `(//h2[@data-carousel-title='${contentHeader}']/following-sibling::div[@class='carousel carousel-list']//div[@class='owl-item active'])[${index}] | (//h2[@data-carousel-title='${contentHeader}']/following-sibling::div[@class='carousel carousel-list']//div[@class='owl-item active top-10-owl-div'])[${index}]`
        );
      }
      ...
      get ageratings(){
        return $(`//ul[@class='detail-data']//child::li[text()='A'] | //ul[@class='detail-data']//child::li[text()='UA-7'] | //ul[@class='detail-data']//child::li[text()='UA-13'] | //ul[@class='detail-data']//child::li[text()='U']`)
      }
      ...
      get viewAllOptionsInPages(){
        return $$(`//h2[@class='Heading--carousel']//a[@class='Heading-link see-all']/span`)
      }

      get viewAllOptionsCourouselHeaders(){
        return $$(`//h2[@class='Heading--carousel']//a[@class='Heading-link see-all']/span/parent::a/preceding-sibling::div`);
      }

       vieAllOptionClickRandowmly(text:string){
        return $(`//h2[@class='Heading--carousel']//a[@class='Heading-link see-all']/span[text()='${text}']`)
      }

      get TitleOfTheViewAllPage(){
        return $(`//h1[@class='Heading Heading--md Heading--separator']`);
      }

      get allContentsInViewAllPage(){
        return $$(`//div[@class='grid_media']/child::div[@class='catalogue-item']//a`)
      }
